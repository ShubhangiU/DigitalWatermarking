...
%>
   ...
   <tr><td><%=n%></td>
<td><img alt="<%=rs.getString("fgimg")%>" src="water-mark-image/<%=rs.getString("fgimg")%>" height="200" width="400" /></td>
<td><img alt="<%=rs.getString("bgimg")%>" src="water-mark-image/<%=rs.getString("bgimg")%>" height="200" width="400" /></td>
<td><img alt="<%=rs.getString("cmbimg")%>" src="water-mark-image/<%=rs.getString("cmbimg")%>" height="200" width="400" /></td></tr>
